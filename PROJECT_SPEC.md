...
- [x] Phase 0–4 全部通过各自验收标准（含自动化断言脚本）——共 81 条，`tests/test_phase0..4.py`（其中 14 条是需要 key 的 live 断言。写下 52 那天确实是 52，之后加测试没人改这个数——现在由 `test_a_documented_assertion_count_matches_the_file` 守着）
